...
class LogitsProcessorOutput:
    ...
    # STANDALONE_REMOTE tree seed: captured from logits before sampler mutation.
    tree_seed_topk_p: Optional[torch.Tensor] = None
    tree_seed_topk_index: Optional[torch.Tensor] = None
