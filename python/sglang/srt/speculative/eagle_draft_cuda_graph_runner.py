...
class EAGLEDraftCudaGraphRunner:
    def __init__(self, eagle_worker: EAGLEWorker):
        ...
        self.need_draft_hidden = bool(getattr(eagle_worker, "need_draft_hidden", True))
    ...
    def capture_one_batch_size(
        ...
        hidden_states = (
            None
            if buffers.hidden_states is None
            else buffers.hidden_states[:num_seqs]
        )
